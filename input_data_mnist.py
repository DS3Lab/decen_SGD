...
MINIMUM_FILE_SIZE = 700

IMAGE_DIRECTORY = "/mnt/ds3lab/datasets/MNIST/basic/small"
...
def load_image_as_array(filepath):
    ...
    :return: array of image with size IMAGE_WIDTH*IMAGE_HEIGHT
    """
...
def transform_images(images, randomize = False):
    ...
    images = images.reshape(images.shape[0], RAW_IMAGE_HEIGHT, RAW_IMAGE_WIDTH)
    ...
    return transformed.reshape(transformed.shape[0], IMAGE_HEIGHT*IMAGE_WIDTH)
