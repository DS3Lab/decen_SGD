...
def load_data():
  ...
  ys = []
  for i in range(1, 6):
    filename = '/mnt/ds3lab/litian/input_data/cifar-10-batches-py/data_batch_' + str(i)
  ...
  x_test, y_test = load_CIFAR10_batch('/mnt/ds3lab/litian/input_data/cifar-10-batches-py/test_batch')
